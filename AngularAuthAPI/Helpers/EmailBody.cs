namespace AngularAuthAPI.Helpers
{
    ...
    {
        public static string EmailSrtingBody(string email, string emailToken)
        {
            return $@"<html>
                ...
                <div style=""height: auto;background: linear-gradient(to top, #c9c9ff 50%, #6e6ef6 90%) no-repeat;width: 400px;padding: 30px;"">
                    <div>
                        <div>
                            ...
                            <hr>
                            <p>you're receving this e-mail because you requested a password reset for your Let's Program account.</p>
